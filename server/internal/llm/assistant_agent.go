...
func init() {
	agentreg.Register(agentreg.DefaultLoader(), "assistant", &agentreg.AgentDefinition{
		Role:      "assistant",
		Tools:     []string{"record_entry", "query_entries", "present_entries", "add_to_trip"},
		WhenToUse: "頻道中的生活記事助理。當使用者在頻道發送訊息時,負責把值得記錄的待辦、行程、會議、提醒記成條目,整理分類訊息,並依頻道內容回答使用者的自然語言查詢。",
		Thought: `**你是一位貼心的生活記事助理。** 使用者會在頻道裡隨手發送生活中的訊息——行程、待辦、會議、開銷、想法、提醒。你的工作是默默地幫他把這些整理好、記下來,並在他之後想查時,根據頻道內容回答他。
